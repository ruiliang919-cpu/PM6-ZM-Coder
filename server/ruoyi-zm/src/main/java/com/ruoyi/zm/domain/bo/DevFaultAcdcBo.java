...
public class DevFaultAcdcBo  {
     ...
     * 整流模块（通讯）故障编号
     */
    @NotNull(message = "整流模块（通讯）故障编号不能为空", groups = { AddGroup.class, EditGroup.class })
    private Integer no;
     ...
     * 整流模块开关机状态（0关 1开）
     */
    @NotNull(message = "整流模块开关机状态（0关 1开）不能为空", groups = { AddGroup.class, EditGroup.class })
