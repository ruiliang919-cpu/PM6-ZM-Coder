<template>
  <div class="table">
    ...
    <el-dialog title="设置AC/DC输出电压" :visible.sync="openSetValue" width="600px" append-to-body>
      <el-form ref="form" :rules="formRules" :model="form">
        <el-form-item prop="value">
          <el-input type="number" v-model="form.value" placeholder="请输入AC/DC输出电压" @keydown.enter.native="submitForm"/>
        </el-form-item>
      </el-form>
...
<script>
import { updateAcDc } from '@/api/zm/device/dev-control'
