<template>
  <div class="app-container">
    ...
    :header-cell-style="handleHeaderRowStyle" ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
