  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        :header-cell-style="handleHeaderRowStyle" v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitFileForm" @keydown.enter="submitForm">确 定</el-button>
