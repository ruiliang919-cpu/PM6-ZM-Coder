  ...
  <el-drawer size="280px" :visible="visible" :with-header="false" :append-to-body="true" :show-close="false">
    <div class="drawer-container">
      <div>
        ...
        <!--        </div>-->
<!--        <div class="drawer-item" v-if="isInElectron()">-->
<!--          <span>开启 devTools</span>-->
<!--          <el-switch @change="handleOpenDevTools" class="drawer-switch" :value="devtools"/>-->
<!--        </div>-->
